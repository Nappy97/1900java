package com.nappy.project.config.oauth;

import com.nappy.project.config.auth.PrincipalDetail;
import com.nappy.project.config.oauth.provider.GoogleUserInfo;
import com.nappy.project.config.oauth.provider.KakaoUserInfo;
import com.nappy.project.config.oauth.provider.NaverUserInfo;
import com.nappy.project.config.oauth.provider.OAuth2UserInfo;
